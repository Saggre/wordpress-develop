...
class Tests_Functions_wpIdnEncodeUri extends WP_UnitTestCase {
	...
	public function data_wp_idn_encode_uri() {
		return array(
			...
			array( 'https://Ｔシャツ', 'https://xn--xck0a6fw617g/' ),
			...
			array( 'https://น้ำหอม', 'https://xn--q3cq3ai2a5k/' ),
			array( 'https://สำนวน', 'https://xn--q3ca5bk9b/' ),
			array( 'https://chambres-dhôtes.example', 'https://xn--chambres-dhtes-bpb.example/' ),
			array( 'https://น้ำใสใจจริง.example', 'https://xn--72cba0e8bxbxdm4kb6d.example/' ),
